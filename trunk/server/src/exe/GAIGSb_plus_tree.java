...
/**
 * <p><code>GAIGSb_plus_tree</code> extends the <code>Tree</code> class, providing
...
public class GAIGSb_plus_tree  extends Tree implements GAIGSdatastr {
...
//---------------------- Constructors -------------------------------------------
     ...
     */
    public GAIGSb_plus_tree(boolean b) {
     ...
     */
    public GAIGSb_plus_tree(boolean b, String name, String color, double x1, double y1, double x2, double y2, double fontSize) {
        super(b);
        this.name = name;
        this.color = color;
